...
# the custom scaler class, that uses the standard scaler class but always use to choose what data gets standardized
...
# Will be used to load, preprocess, and train data
class absenteeism_model():
        ...
        # take a data file (*.csv) and preprocesses the data
